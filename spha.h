...
c     Real constants
      REAL CN,PI
      PARAMETER (CN=0.6,PI=3.14159265359)
...
C     gravrad: quantities for computing gravitational radiation losses 
     ...
     $             ZGRMAX,XGRLIM,YGRLIM,ZGRLIM
      ...
      COMMON/INTPAR/ GAM,N,NNOPT,HMIN,HMAX
      COMMON/OUTP/ DT,T,VXS,VYS,VZS,TF,DTOUT,NOUT,NIT,xm2,ym2,zm2     
      COMMON/WTABUL/ WTAB,DWTAB,CTAB                        
      COMMON/PART/X,Y,Z,VX,VY,VZ,AM,HP,A,RHO,POR2,GRPOT  
      COMMON/DYN/ VXDOT,VYDOT,VZDOT,ADOT,GX,GY,GZ,ux,uy,uz
     ...
     $      QDAR,AMNS,RNS,RP,VPEAK,TRELOFF,NGRAVRAD,SOL
