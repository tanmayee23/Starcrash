...
*****************************************************
c     Release 1.0
C     Calculates gravitational forces by FFTs on a grid, as well as
c     second derivatives of grav. potential for radiation reaction.
...
**********************************************************
     ...
     $     PHIT(n1grav,NNgrav,nnp)
      ...
      REAL FGRXX(Ngrav,Ngrav,nnp),FGRYY(Ngrav,Ngrav,nnp)
      REAL FGRXY(Ngrav,Ngrav,nnp)
      REAL mygrpot(N),myGx(N),myGy(N),myGz(N)
      REAL mygxx(N),mygxy(N),mygyy(N),mygxz(N),mygyz(N)
      REAL mygzz(N)
      ...
      REAL gxxtot,gyytot,gzztot,gxytot,gxztot,gyztot,rip5
      ...
      DO K=1,nnp
         DO J=2,Ngrav
            DO I=2,Ngrav
               ...
               FGRXX(i,j,k)=(-1.0*PHI(I-1,J,k)-PHI(I+1,J,k)+
     $              2.0*PHI(I,J,K))/hx**2
               FGRYY(i,j,k)=(-1.0*PHI(I,J-1,k)-PHI(I,J+1,k)+
     $              2.0*PHI(I,J,K))/hy**2
               FGRXY(i,j,k)=(PHI(I-1,J+1,K)+PHI(I+1,J-1,K)-
     $              PHI(I+1,J+1,K)-PHI(I-1,J-1,K))/(HX2*HY2)
            ENDDO
         ENDDO
      ENDDO
...
C     Calculate forces for particles inside grid by finite diff:
     ...
     $              (AIN-IN)*phi(IN1,JN1,KNc)))
               myGxx(IP)=(KN1-AKN)*(
     $              (JN1-AJN)*((IN1-AIN)*FGRXX(IN,JN,knc)+
     $              (AIN-IN)*FGRXX(IN1,JN,knc))+
     $              (AJN-JN)*((IN1-AIN)*FGRXX(IN,JN1,knc)+
     $              (AIN-IN)*FGRXX(IN1,JN1,knc)))
               myGxy(IP)= (KN1-AKN)*(
     $              (JN1-AJN)*((IN1-AIN)*FGRxY(IN,JN,KNc)+
     $              (AIN-IN)*FGRXY(IN1,JN,KNc))+
     $              (AJN-JN)*((IN1-AIN)*FGRXY(IN,JN1,KNc)+
     $              (AIN-IN)*FGRXY(IN1,JN1,KNc)))
               myGyy(IP)= (KN1-AKN)*(
     $              (JN1-AJN)*((IN1-AIN)*FGRYY(IN,JN,KNc)+
     $              (AIN-IN)*FGRYY(IN1,JN,KNc))+
     $              (AJN-JN)*((IN1-AIN)*FGRYY(IN,JN1,KNc)+
     $              (AIN-IN)*FGRYY(IN1,JN1,KNc)))
               myGxz(IP)=-1.0*(aKN-KN)/hz2*(
     $              (JN1-AJN)*((IN1-AIN)*FGRX(IN,JN,KNc)+ 
     $              (AIN-IN)*FGRX(IN1,JN,KNc))+
     $              (AJN-JN)*((IN1-AIN)*FGRX(IN,JN1,KNc)+
     $              (AIN-IN)*FGRX(IN1,JN1,KNc)))
               myGYz(IP)=-1.0*(aKN-KN)/hz2*(
     $              (JN1-AJN)*((IN1-AIN)*FGRY(IN,JN,KNc)+ 
     $              (AIN-IN)*FGRY(IN1,JN,KNc))+
     $              (AJN-JN)*((IN1-AIN)*FGRY(IN,JN1,KNc)+
     $              (AIN-IN)*FGRY(IN1,JN1,KNc)))
               myGzz(IP)=(2.0-3.0*(aKN-KN))/hz**2*(
     $              (JN1-AJN)*((IN1-AIN)*phi(IN,JN,KNc)+ 
     $              (AIN-IN)*phi(IN1,JN,KNc))+
     $              (AJN-JN)*((IN1-AIN)*phi(IN,JN1,KNc)+
     $              (AIN-IN)*phi(IN1,JN1,KNc)))
     ...
     $              (AJN-JN)*((IN1-AIN)*phi(IN,JN1,KN1c)+
     $              (AIN-IN)*phi(IN1,JN1,KN1c)))
               myGxx(IP)=myGxx(IP)+(AKN-KN)*(
     $              (JN1-AJN)*((IN1-AIN)*FGRXX(IN,JN,KN1c)+
     $              (AIN-IN)*FGRXX(IN1,JN,KN1c))+
     $              (AJN-JN)*((IN1-AIN)*FGRXX(IN,JN1,KN1c)+
     $              (AIN-IN)*FGRXX(IN1,JN1,KN1c)))
               myGxy(IP)=myGxy(IP)+(AKN-KN)*(
     $              (JN1-AJN)*((IN1-AIN)*FGRXY(IN,JN,KN1c)+
     $              (AIN-IN)*FGRXY(IN1,JN,KN1c))+
     $              (AJN-JN)*((IN1-AIN)*FGRXY(IN,JN1,KN1c)+
     $              (AIN-IN)*FGRXY(IN1,JN1,KN1c)))
               myGyy(IP)=myGyy(IP)+(AKN-kn)*(
     $              (JN1-AJN)*((IN1-AIN)*FGRYY(IN,JN,KN1c)+
     $              (AIN-IN)*FGRYY(IN1,JN,KN1c))+
     $              (AJN-JN)*((IN1-AIN)*FGRYY(IN,JN1,KN1c)+
     $              (AIN-IN)*FGRYY(IN1,JN1,KN1c)))
               myGxz(IP)=myGxz(IP)-(AKN-KN1)/hz2*(
     $              (JN1-AJN)*((IN1-AIN)*FGRX(IN,JN,KN1c)+
     $              (AIN-IN)*FGRX(IN1,JN,KN1c))+
     $              (AJN-JN)*((IN1-AIN)*FGRX(IN,JN1,KN1c)+
     $              (AIN-IN)*FGRX(IN1,JN1,KN1c)))
               myGyz(IP)=myGyz(IP)-(AKN-KN1)/hz2*(
     $              (JN1-AJN)*((IN1-AIN)*FGRY(IN,JN,KN1c)+
     $              (AIN-IN)*FGRY(IN1,JN,KN1c))+
     $              (AJN-JN)*((IN1-AIN)*FGRY(IN,JN1,KN1c)+
     $              (AIN-IN)*FGRY(IN1,JN1,KN1c)))
               myGzz(IP)=myGzz(IP)+(3.0*(AKN-KN)-1.0)
     $              /hz**2*(
     $              (JN1-AJN)*((IN1-AIN)*phi(IN,JN,KN1c)+
     $              (AIN-IN)*phi(IN1,JN,KN1c))+
     $              (AJN-JN)*((IN1-AIN)*phi(IN,JN1,KN1c)+
     ...
     $              (AIN-IN)*phi(IN1,JN1,KN2c)))
               myGxz(IP)=myGxz(IP)-(KN-AKN)/hz2*(
     $              (JN1-AJN)*((IN1-AIN)*FGRX(IN,JN,KN2c)+
     $              (AIN-IN)*FGRX(IN1,JN,KN2c))+
     $              (AJN-JN)*((IN1-AIN)*FGRX(IN,JN1,KN2c)+
     $              (AIN-IN)*FGRX(IN1,JN1,KN2c)))
               myGyz(IP)=myGyz(IP)-(KN-AKN)/hz2*(
     $              (JN1-AJN)*((IN1-AIN)*FGRY(IN,JN,KN2c)+
     $              (AIN-IN)*FGRY(IN1,JN,KN2c))+
     $              (AJN-JN)*((IN1-AIN)*FGRY(IN,JN1,KN2c)+
     $              (AIN-IN)*FGRY(IN1,JN1,KN2c)))
               myGzz(IP)=myGzz(IP)+(KN-AKN)/hz**2*(
     $              (JN1-AJN)*((IN1-AIN)*phi(IN,JN,KN2c)+
     $              (AIN-IN)*phi(IN1,JN,KN2c))+
     $              (AJN-JN)*((IN1-AIN)*phi(IN,JN1,KN2c)+
     $              (AIN-IN)*phi(IN1,JN1,KN2c)))
     ...
     $              (AIN-IN)*phi(IN1,JN1,KNm1c)))
               myGXz(IP)=myGXz(IP)-(kn1-akn)/hz2*(
     $              (JN1-AJN)*((IN1-AIN)*FGRX(IN,JN,KNm1c)+
     $              (AIN-IN)*FGRX(IN1,JN,KNm1c))+
     $              (AJN-JN)*((IN1-AIN)*FGRX(IN,JN1,KNm1c)+
     $              (AIN-IN)*FGRX(IN1,JN1,KNm1c)))
               myGYz(IP)=myGYz(IP)-(kn1-akn)/hz2*(
     $              (JN1-AJN)*((IN1-AIN)*FGRY(IN,JN,KNm1c)+
     $              (AIN-IN)*FGRY(IN1,JN,KNm1c))+
     $              (AJN-JN)*((IN1-AIN)*FGRY(IN,JN1,KNm1c)+
     $              (AIN-IN)*FGRY(IN1,JN1,KNm1c)))
               myGzZ(IP)=myGZz(IP)+(akn-kn1)/hz**2*(
     $              (JN1-AJN)*((IN1-AIN)*phi(IN,JN,KNm1c)+
     $              (AIN-IN)*phi(IN1,JN,KNm1c))+
     $              (AJN-JN)*((IN1-AIN)*phi(IN,JN1,KNm1c)+
     $              (AIN-IN)*phi(IN1,JN1,KNm1c)))
     ...
     $     MPI_COMM_WORLD,ierr)
      CALL MPI_ALLREDUCE(myGxx,Gxx,N,MPI_REAL,MPI_SUM,
     $     MPI_COMM_WORLD,ierr)
      CALL MPI_ALLREDUCE(myGxy,Gxy,N,MPI_REAL,MPI_SUM,
     $     MPI_COMM_WORLD,ierr)
      CALL MPI_ALLREDUCE(myGyy,Gyy,N,MPI_REAL,MPI_SUM,
     $     MPI_COMM_WORLD,ierr)
      CALL MPI_ALLREDUCE(myGxz,Gxz,N,MPI_REAL,MPI_SUM,
     $     MPI_COMM_WORLD,ierr)
      CALL MPI_ALLREDUCE(myGyz,Gyz,N,MPI_REAL,MPI_SUM,
     $     MPI_COMM_WORLD,ierr)
      CALL MPI_ALLREDUCE(myGzz,Gzz,N,MPI_REAL,MPI_SUM,
     $     MPI_COMM_WORLD,ierr)
...
C     Calculate forces for particles outside grid by monopole approx:
     ...
     $     'QGRAV: NPOUT=',NPOUT,'  AMIN=',AMIN
      ...
      IF(NPOUT.GT.N/5) THEN
         if(myrank.eq.0)WRITE(6,*)'WARNING!! In qgrav2: NPOUT.GT.N/5???'
c         STOP
      ENDIF
     ...
     $           +(Z(IP)-ZCMIN)**2)**0.5
            ...
            gxx(ip)=amin*(3.0*(xcmin-x(ip))**2-rip**2)/rip5
            gyy(ip)=amin*(3.0*(ycmin-y(ip))**2-rip**2)/rip5
            gzz(ip)=amin*(3.0*(zcmin-z(ip))**2-rip**2)/rip5
            gxy(ip)=3.0*amin*(xcmin-x(ip))*(ycmin-y(ip))/rip5
            gxz(ip)=3.0*amin*(xcmin-x(ip))*(zcmin-z(ip))/rip5
            gyz(ip)=3.0*amin*(ycmin-y(ip))*(zcmin-z(ip))/rip5
            GxTOT=GxTOT-AM(IP)*(XCMIN-X(IP))/RIP3
            GyTOT=GyTOT-AM(IP)*(YCMIN-Y(IP))/RIP3
            GzTOT=GzTOT-AM(IP)*(ZCMIN-Z(IP))/RIP3
            gxxtot=gxxtot+
     $           am(ip)*(3.0*(xcmin-x(ip))**2-rip**2)/rip5
            gyytot=gyytot+
     $           am(ip)*(3.0*(ycmin-y(ip))**2-rip**2)/rip5
            gzztot=gzztot+
     $           am(ip)*(3.0*(zcmin-z(ip))**2-rip**2)/rip5
            gxytot=gxytot+
     $           3.0*am(ip)*(xcmin-x(ip))*(ycmin-y(ip))/rip5
            gxztot=gxztot+
     $           3.0*am(ip)*(xcmin-x(ip))*(zcmin-z(ip))/rip5
            gyztot=gyztot+
     $           3.0*am(ip)*(ycmin-y(ip))*(zcmin-z(ip))/rip5
         ENDIF
      ENDDO
      ...
      DO IP=1,N
         IF(.NOT.OUT(IP)) THEN
            ...
            Gy(IP)=Gy(IP)+GyTOT
            Gz(IP)=Gz(IP)+GzTOT
            gxx(ip)=gxx(ip)+gxxtot
            gxy(ip)=gxy(ip)+gxytot
            gxz(ip)=gxz(ip)+gxztot
            gyy(ip)=gyy(ip)+gyytot
            gyz(ip)=gyz(ip)+gyztot
            gzz(ip)=gzz(ip)+gzztot
         ENDIF
      ENDDO
